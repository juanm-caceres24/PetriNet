...
public interface UserInterface {
    ...
    public abstract void showPlaces(Boolean showMinimal, Boolean showTitle, Boolean showIsTracked);
    ...
    public abstract void showTransitionFiring(Transition transition, Boolean showMinimal, Boolean showSegmentsCompletionCounters);
